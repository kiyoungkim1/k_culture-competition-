...
상기 내용을 바탕으로 최종 답변인 숫자는 <result> </result> 사이에 작성해 주세요. 숫자만 작성해야 합니다.
...
<background>내용을 바탕으로 상기 내용을 참고하여 최종적으로 2단어 이내의 답변을 <result> </result> 사이에 작성해 주세요. 2단어 이내로 작성해야합니다.
일반적인 지식이 아니라, 반드시 전통적인 한국의 문화를 기반으로 풀어야 합니다. 알고 있는 정보안에서 가능한 가장 정확한 답을 '한국어'로 작성해야 합니다.
...
상기 내용을 참고하여 최종적으로 완성된 문장의 답변을 <result> </result> 사이에 500자 정도로 작성해 주세요.
